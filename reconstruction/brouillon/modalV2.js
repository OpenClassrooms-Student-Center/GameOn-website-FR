// Modale déconstruite pour tenter de gérér differement les évnements
...
const firstChecker = (value) => {
        ...
        console.log("valeur first checker: ", value);
        if (value == "") {
...
console.log("le formulaire", fullForm);
